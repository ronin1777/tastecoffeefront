...
export default function HomePopularP({ products }) {
        ...
        <section className="products-popular mb-9 md:mb-20">
            <div className="container">
                <div className="section-header flex justify-between items-center text-zinc-700 dark:text-white mb-5 md:mb-12">
                    <div>
                        <h2 className="font-morabba-medium text-xl xs:text-2xl md:text-5xl">محبوب ترین محصولات</h2>
                        <p className="font-morabba text-md xs:text-lg md:text-3xl mt-0.5 md:mt-1.5">پیشنهاد قهوه خورها</p>
                    </div>
                </div>
