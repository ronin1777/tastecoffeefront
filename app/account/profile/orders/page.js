...
export default async function ProfileOrders({ searchParams }) {
    ...
    const res = await fetch(`http://127.0.0.1:8000/api/orders/orders/?${queryParams}`, {
        method: 'GET',
        next: { revalidate: 10 },
        headers: {
    ...
    return (
        <div className="container mt-20 mx-auto">
            <h1 className="text-2xl text-zinc-700 dark:text-white font-bold mb-4">لیست سفارشات</h1>
            <OrdersFilter />
