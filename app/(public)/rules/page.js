...
export default function RulesPage() {
  ...
  const rules = [
...

    {
      ...
      title: "ثبت سفارش",
      content:
        "– دقت در خرید کالا و توجه به مشخصات کالای مورد سفارش بر عهده خریدار است. پیش از تایید نهایی سفارش، موارد ذکر شده را به‌دقت بررسی کنید.\n" +
...

    {
      ...
      title: "تحویل سفارش",
      content:
        "– کلیه سفارشات درب اصلی ساختمان منتهی به خیابان تحویل داده می‌شود و همکاران ما اجازه ورود به فضای داخلی ساختمان، مشاعات یا واحد مربوطه را ندارند.\n" +
